...
/**
 * Cambiar el estilo de la navbar al hacer scroll (Dark semi-transparente con blur)
 */
let lastScroll = 0;
...
window.addEventListener('scroll', () => {
    ...
    if (currentScroll > 100) {
        // Aplica el fondo semi-transparente y el blur
        navbar.style.background = 'rgba(10, 10, 10, 0.95)';
        navbar.style.backdropFilter = 'blur(10px)';
    } else {
        // Vuelve al fondo sólido (o casi sólido)
...
/**
 * Cerrar el menú al hacer clic fuera de él (en móviles) - Reversible
 */
 ...
 */
// Selector para todas las tarjetas, incluyendo las flip-card
const observeElements = document.querySelectorAll('.flip-card, .service-card-dark, .testimonial'); 
